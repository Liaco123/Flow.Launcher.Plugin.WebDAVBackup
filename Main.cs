...
public class Main : IPlugin, ISettingProvider
{
        ...
        int restartDelaySeconds)
    {
        ...
        var lines = new[]
        {
            ...
            "    $folderCheckHeaders = $headers.Clone()",
            "    $folderCheckHeaders['Depth'] = '0'",
            "    try {",
            "        Invoke-WebDavRequest -Method 'PROPFIND' -Uri $remoteFolderUri -Headers $folderCheckHeaders | Out-Null",
